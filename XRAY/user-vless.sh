...
vlesslink3="vless://${uuid}@104.22.39.195:${tls}?type=ws&encryption=none&security=tls&host=${domain}&path=CF-VINS:http://ufuture.uitm.edu.my/vless-tls&allowInsecure=1&sni=ufuture.uitm.edu.my#XRAY_VLESS_MAXIS_${user}"
...
vlesslink5="vless://${uuid}@104.20.65.29:${tls}?type=ws&encryption=none&security=tls&host=${domain}&path=CF-VINS:http://onlinepayment.celcom.com.my/vless-tls&allowInsecure=1&sni=onlinepayment.celcom.com.my#XRAY_VLESS_CELCOM_${user}"
vlesslink6="vless://${uuid}@104.17.112.188:${none}?type=ws&encryption=none&security=none&host=${domain}&path=CF-VINS:http://cdn.who.int/vless-ntls#XRAY_VLESS_YES_${user}"
clear
echo -e ""
echo -e "
[XRAY VLESS WS]"
